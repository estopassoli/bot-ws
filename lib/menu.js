var bot = require('../database/json/bot.json')
...
|- *!menu* 6 -> Upgrade Elo.
|--------------------------
|- Chave PIX caso queira ajudar:
|- ${process.env.PIXKEY.trim()}
|- PS: Ajuda monetária é opcional
|
...
|- *!dlista* +55 (21) 9xxxx-xxxx - Remove o número na lista negra do 
grupo.
...
|>---- ☾ ⚙️ *Upgrades* ⚙️☽
|
| (Free Tier) 🟤 Bronze - *${bot.limite_diario.limite_tipos.bronze}* cmds/dia
| (R$ 5,00) ⚪ Prata - *${bot.limite_diario.limite_tipos.prata}* cmds/dia
| (R$ 7.50) 🟡 Ouro - *${bot.limite_diario.limite_tipos.ouro}* cmds/dia
| (R$ 15,00) 🟢 Platina - *${bot.limite_diario.limite_tipos.platina}* cmds/dia
| (R$ 25,00) 🔵 Diamante - *${bot.limite_diario.limite_tipos.diamante}* cmds/dia
| (R$ 32,00) 🎖️ VIP - *∞* cmds/dia
|
| *Upgrade são pagos apenas uma vez.*
|--------------------------
| Para fazer seu upgrade
| Contate o Admin:
| https://wa.me/5513996597134
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
