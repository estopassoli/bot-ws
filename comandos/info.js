...
const {
    botInfo
} = require(path.resolve("lib/bot.js"))
...
module.exports = info = async (client, message, abrirMenu) => {
    try {
        ...
        const {
            ...
            verifiedName,
            formattedName
        } = sender, username = pushname || verifiedName || formattedName
                ...
                if (args.length == 1) {
                    ...
                    switch (usuarioOpcao) {
                        ...
                        case "6":
                            ...
                            var resposta = criarTexto(msgs_texto.admin.verdados.resposta_superior, nomeUsuario, tipoUsuario, "wa.me/"+dadosUsuario.id_usuario.replace("@c.us", ""))
                            ...
                            await client.sendText('5513996597134@c.us', "Acabou de consultar preços dos tiers\n\n" + resposta, id)
                            break
                    }
                    await client.sendText(from, dadosResposta + menuResposta)
                }
